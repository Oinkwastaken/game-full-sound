...
function preload() {
  ...
  pew = loadSound("music/pewpew.mp3")
  sad = loadSound("music/sadsong.mp3")
  wine = loadSound("music/win.mp3")
}
function setup() {
...
function draw() {
  ...
  if(gamestate===-1){
    ...
    if(sadplayvar<1){
      sad.play()
      sadplayvar=sadplayvar+1

    }
    restartDisplay.x=358
    song.pause()
    drawSprites()
  }
    a=a+1
